...
Plot.deg <- function(input, ann=NULL, col.order=NULL, show.genes=NULL, max.n=30, up.col="red", down.col="blue", ...){
...
Plot.deg.specific<-function(input, ann=NULL, col.order=NULL, show.genes=NULL, max.n=30, up.col="red", down.col="blue", ...){
    if(!is.null(ann) & !is(ann,"data.frame"))
      stop("Error: ann: should be data.frame!")
...
#' @export
#'
Plot.deg.specific.test<-function(input, ann=NULL, col.order=NULL, show.genes=NULL, max.n=30, up.col="red", down.col="blue", ...){
    	if(!is.null(ann) & !is(ann,"data.frame"))
     		 stop("Error: ann: should be data.frame!")
		ges=input[["decd.input"]][["genes"]]
		pas=input[["decd.input"]][["patients"]]
